...
from core.data import IndexDataset, CIFARDataset, SVHNDataset, CINIC10Dataset, STL10Dataset, CUB_200_2011, Caltech101Dataset, Food101Dataset
...
parser.add_argument(
    ...
    choices=[
        ...
        'svhn', 'cinic10', 'stl10', 'cub200', 'food101', 'caltech101'
    ]
)
