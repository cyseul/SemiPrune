...
BASE_DIR="./data-model-0504/sun397/fix-aum"

RUNS=(1 2 3 4)

CORESET_RATIOS=(0.7 0.5 0.3 0.2 0.1)
MIS_RATIOS=(0.1 0.3 0.5 0.7 0.8)
...
run_job() {
  ...
  python train.py \
    ...
    --coreset \
    --coreset-mode budget \
    --data-score-path ./data-model-0504/sun397/fixmatch-ps/full-train/data-score-full-train.pickle \
