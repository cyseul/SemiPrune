...
SCORE_SET_NAME="${SCORE_SET_NAME:-zcore-hard}"
DATA_DIR="${DATA_DIR:-../data/sun397_full_split_resized_512}"
SCORE_PATH="${SCORE_PATH:-../results/sun397/zcore-sun397-clip-resnet18-1000Ks-2sd-ri-1000nn-4ex-0/score.npy}"
...
echo "All SUN397 zcore hard coreset jobs finished."
