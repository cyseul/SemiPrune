...
class FeatureExtractionPipeline:
    def __init__(self, args, cache_backbone=False, datapath='../data'):
        ...
        dataset_train = get_dataset(args.dataset, datapath=datapath,
                                    ...
                                    test_embedding_path=getattr(args, 'test_embedding_path', None),
                                    test_label_path=getattr(args, 'test_label_path', None))
...
def get_eval_args(notebook=False):
    ...
    parser.add_argument('--dataset', default='CIFAR100', choices=['CIFAR100', 'CIFAR10', "STL10", \
                                                                "CIFAR20", "IN1K", "IN50", 'IN100', "IN200", "Caltech101", "caltech101"], type=str)
    ...
    parser.add_argument('--embedding_path', default=None, type=str,
        help='Optional path to precomputed embeddings.pt. Used with --precomputed.')
    parser.add_argument('--label_path', default=None, type=str,
        help='Optional path to labels for --embedding_path.')
    parser.add_argument('--test_embedding_path', default=None, type=str,
        help='Optional path to precomputed test embeddings. Used only for eval test split.')
    parser.add_argument('--test_label_path', default=None, type=str,
        help='Optional path to labels for --test_embedding_path.')
